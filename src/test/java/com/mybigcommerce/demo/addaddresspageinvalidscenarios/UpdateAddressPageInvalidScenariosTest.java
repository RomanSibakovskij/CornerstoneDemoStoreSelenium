...
public class UpdateAddressPageInvalidScenariosTest extends TestMethods {
    ...
    //Test 005w -> invalid update user address test - invalid user address format (special symbols only) (the user address edit hasn't been aborted, test has failed)
    @Test
    @DisplayName("Invalid Update User Address Test - Invalid Address Format")
    @Tag("Invalid_Update_User_Address")
    @Tag("Invalid_Singular_Input_Format")
    void invalidAddressEditInvalidAddressFormatTest() {
        //user navigation to register page test
        navigateToRegisterPageTest();
        //valid user account creation test
        validUserAccountCreationTest();
        //invalid update user address test - invalid user address format (special symbols only)
        invalidEditUserAddressInvalidAddressFormatTest();
    }

    //Test 005x -> invalid update user address test - invalid user city format (special symbols only) (the user address edit hasn't been aborted, test has failed)
    @Test
    @DisplayName("Invalid Update User Address Test - Invalid City Format")
    @Tag("Invalid_Update_User_Address")
    @Tag("Invalid_Singular_Input_Format")
    void invalidAddressEditInvalidCityFormatTest() {
        //user navigation to register page test
        navigateToRegisterPageTest();
        //valid user account creation test
        validUserAccountCreationTest();
        //invalid update user address test - invalid user city format (special symbols only)
    ...
    //Test 005z -> invalid update user address test - invalid user phone format (special symbols only) (the user address edit hasn't been aborted, test has failed)
    @Test
    @DisplayName("Invalid Update User Address Test - Invalid Phone Format")
    @Tag("Invalid_Update_User_Address")
    @Tag("Invalid_Singular_Input_Format")
    void invalidAddressEditInvalidPhoneFormatTest() {
        //user navigation to register page test
        navigateToRegisterPageTest();
        //valid user account creation test
        validUserAccountCreationTest();
        //invalid update user address test - invalid user phone format (special symbols only)
        invalidEditUserAddressInvalidPhoneFormatTest();
    }
