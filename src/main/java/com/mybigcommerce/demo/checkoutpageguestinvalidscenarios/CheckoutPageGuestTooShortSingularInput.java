...
public class CheckoutPageGuestTooShortSingularInput extends BasePage{
    ...
    private String tooShortGuestCreditCardExpDate;
    private String tooShortGuestCreditCardName;
    private String tooShortGuestCreditCardCVVNumber;
    ...
    //invalid guest payment input data getter - too short guest credit card exp date (3 digits)
    public void invalidGuestPaymentInputDataTooShortCredCardExpDateGetter(){

        tooShortGuestCreditCardExpDate = "11/3";
        validGuestCreditCardName = TestDataGenerator.getRandomFirstName() + " " + TestDataGenerator.getRandomLastName();
        validGuestCreditCardCVVNumber = TestDataGenerator.generateCVV();

        System.out.println("Invalid generated checkout guest payment input data (too short guest credit card exp date): " + "\n");

        logger.info("Valid test credit card number (too short guest credit card exp date): " + validTestCreditCardNumber);
        logger.info("Too short guest credit card expiration date: " + tooShortGuestCreditCardExpDate);
        logger.info("Valid guest credit card full name (too short guest credit card exp date): " + validGuestCreditCardName);
        logger.info("Valid guest credit card CVV number (too short guest credit card exp date): " + validGuestCreditCardCVVNumber);

        System.out.println("\n");

    }

    //invalid guest payment input data getter - too short guest credit card name (1 char)
    public void invalidGuestPaymentInputDataTooShortCreditCardNameGetter(){

        validGuestCreditCardExpDate = TestDataGenerator.generateExpirationDate();
        tooShortGuestCreditCardName =  "G" ;
        validGuestCreditCardCVVNumber = TestDataGenerator.generateCVV();

        System.out.println("Invalid generated checkout guest payment input data (too short guest credit card name): " + "\n");

        logger.info("Valid test credit card number (too short guest credit card name): " + validTestCreditCardNumber);
        logger.info("Valid guest credit card expiration date (too short guest credit card name): " + validGuestCreditCardExpDate);
        logger.info("Too short credit card full name: " + tooShortGuestCreditCardName);
        logger.info("Valid guest credit card CVV number (too short guest credit card name): " + validGuestCreditCardCVVNumber);

        System.out.println("\n");

    }

    //invalid guest payment input data getter - too short guest credit card CVV number (2 digits)
    public void invalidGuestPaymentInputDataTooShortCVVGetter(){

        validGuestCreditCardExpDate = TestDataGenerator.generateExpirationDate();
        validGuestCreditCardName = TestDataGenerator.getRandomFirstName() + " " + TestDataGenerator.getRandomLastName();
        tooShortGuestCreditCardCVVNumber = "34";

        System.out.println("Invalid generated checkout guest payment input data (too short guest credit card CVV number): " + "\n");

        logger.info("Valid test credit card number (too short guest credit card CVV number): " + validTestCreditCardNumber);
        logger.info("Valid guest credit card expiration date (too short guest credit card CVV number): " + validGuestCreditCardExpDate);
        logger.info("Valid guest credit card full name (too short guest credit card CVV number): " + validGuestCreditCardName);
        logger.info("Too short guest credit card CVV number: " + tooShortGuestCreditCardCVVNumber);
    ...
    public void inputTooShortPaymentGuestCreditCardExpDateIntoCreditCardExpDateInputField(){checkoutPagePaymentCreditCardExpDateInputField.sendKeys(tooShortGuestCreditCardExpDate);}
    public void inputTooShortPaymentGuestCreditCardNameIntoCreditCardNameInputField(){checkoutPagePaymentCreditCardNameInputField.sendKeys(tooShortGuestCreditCardName);}
    public void inputTooShortPaymentGuestCreditCardCVVIntoCreditCardCVVInputField(){checkoutPagePaymentCVVNumberInputField.sendKeys(tooShortGuestCreditCardCVVNumber);}
